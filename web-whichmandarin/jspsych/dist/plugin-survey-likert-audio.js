...
var jsPsychSurveyLikert = (function (jspsych) {
  ...
  class SurveyLikertPlugin {
      ...
      trial(display_element, trial) {
          ...
          html += '<table><tbody><tr><thead><tr><th></th>';
          //add head of the table
          for (var i =0; i < trial.questions[0].labels.length; i++){
            html += '<th>'+ trial.questions[0].labels[i] +'</th>'
          }
          html += '</tr></thead>';
          for (var i = 0; i < trial.questions[0].statements.length; i++){
            var typeName = "radio"+ i;
            html += '<tr><th>'+ trial.questions[0].statements[i].prompt +'</th>'+
                    '<td><input id="answer-1-1" type="radio" name='+ typeName +'><label for="answer-1-1"></label></td>'+
                    '<td><input id="answer-1-1" type="radio" name='+ typeName +'><label for="answer-1-1"></label></td></tr>'
          }
          //add statements
          html += 
            // '<table><tbody><tr>'+
            // '<thead><tr><th></th><th>对</th><th>错</th></tr></thead>'+
            // '<th>'+ trial.questions[0].statements[0].prompt +'</th>'+
            // '<td><input id="answer-1-1" name="answer-1" type="radio"><label for="answer-1-1"></label></td>'+
            // '<td><input id="answer-1-2" name="answer-1" type="radio"><label for="answer-1-2"></label></td>'+
            '</tr></tbody></table>';
